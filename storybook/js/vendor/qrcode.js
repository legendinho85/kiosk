...
//---------------------------------------------------------------------
// Vendored for the Tiffin & Me prototype (js/vendor/qrcode.js)
//   package:  qrcode-generator 2.0.4 from the npm registry
//   file:     dist/qrcode.mjs, byte-for-byte below this note
//   source:   https://github.com/kazuhikoarase/qrcode-generator
//   licence:  MIT, full text in js/vendor/qrcode-generator.LICENSE
// Upstream ships this ES module build itself, so no wrapper is needed:
// import qrcode from './qrcode.js' (also named export `qrcode`). The only
// change is this note. Byte mode stores each character code as one byte
// (Latin-1), so js/ar/qr.js hands it UTF-8 bytes as a binary string.
//---------------------------------------------------------------------
